...
class account_invoice_tax(osv.osv):
    ...
    # Method copied from addons/account/invoice.py account_invoice_tax.compute to
    # compute the tax using the discount type.
    def compute(self, cr, uid, invoice_id, context=None):
        ...
        for line in inv.invoice_line:
            ...
            # Modification: compute the line unit price using the discount type
