...
*/
CKEDITOR_BASEPATH = '/prisme_knowledge_enhancement/static/lib/js/ckeditor/';
...
openerp.prisme_knowledge_enhancement = function (oe) {
    ...
    oe.web.form.widgets.add('ckeditor', 'openerp.prisme_knowledge_enhancement.FieldTextCKEditor');

    oe.prisme_knowledge_enhancement.FieldTextCKEditor = oe.web.form.AbstractField.extend(oe.web.form.ReinitializeFieldMixin, {
