...
class MOtoolsParser_webkit_html_bis(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(MOtoolsParser_webkit_html_bis, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(MOtoolsParser_webkit_html_bis, self).set_context(objects, data, ids, report_type=report_type)
...
class MOToolsParser(webkit_report.WebKitParser):
    ...
    def create_single_pdf(self, cursor, uid, ids, data, report_xml, context=None):
        ...
        #sort
        ids = workcenter_line.search(cursor, uid, [],order='production_id, production_id')
...
MOToolsParser('report.mo_tools_bis',
               'mrp.production.workcenter.line',
               'addons/prisme_manufacturing_tools/report/motools_bis.mako',
               parser=MOtoolsParser_webkit_html_bis)