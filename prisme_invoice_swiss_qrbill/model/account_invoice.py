...
class AccountInvoice(models.Model):
    ...
    def _iban_qrcode(self):
        for inv in self:
            ...
            if inv.type == 'out_invoice':
                ...
                except exceptions.except_orm as orm_ex:
    ...
    def _generate_qrbill_content(self, invoice):
        ...
        # Transform Amount to string to join. The number has to contain 2 decimals so we format it (retrieving round numbers doesn't return the two 0 after the decimal, but only one).
