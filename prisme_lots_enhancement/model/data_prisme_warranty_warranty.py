...
class prisme_warranty_warranty(models.Model):
    ...
    def _construct_subject(self, warranty):
        ...
        if warranty.end_date:
            ...
            end_date_string = " (End date : " + warranty.end_date + ")"
        ...
        if lot:
            ...
            subject = "ODOO reminder : warranty from [" + \
                lot.product_id.name + \
                "] (S/N : " + lot.name + customer_string + \
                ") has expired or will soon expire : " + end_date_string
        else:
    ...
    def _construct_body_html(self, warranty):
        ...
        if start_date:
            ...
            body = body + "Start date : " + start_date + "<br/>"
        if end_date:
            self._log('End date found.')
            body = body + "End date : " + end_date + "<br/>" 
        if recall_date:
            self._log('Reminder date found.')
            body = body + "Reminder date : " + recall_date + "<br/><br/>" 
